...
[[_inbox]]
2026-06-11
- [[vst prompt to migrate colab to VM CGE]]
- [[vst research to migrate colab to VM CGE]]
- quick test on grayscales and colors --> white gives best detection
2026-06-09
- model trained on vvel and vcra performs not better in w&b
2026-06-08
- train cos_lr=True
- train cos_lr=True and mosaic=0
- train cls=1
2026-06-07
- select top down images form 5000+ images that were not included since 2026-01
2026-06-06
- short test, seems better
- make image with 2026-05top trained model
2026-06-05
- [colab notebook ](https://colab.research.google.com/drive/1rfAL67MIBLsjftxDs_TmneLN9IPntXIq#scrollTo=OuePT1v2xQlG) compiled no_post=false -> to big
- compiled no_post=true -> 2.1

2026-05-28
- trained 300e b395 with dataset cv_vespa_2026-05_top
- https://wandb.ai/mvdijk-vespcv/vst_2026-05_top/table

2026-05-15
- images from camera in the trap show image slightly from the side
- review [[cli review_folder_placement.py)]]

2026-05-14 hemelvaart 
- runtime 2025-07 still available
- ssd free space 
- 500 images top-down/other selecteren 
- [[cli rename txt files with prefix from image files]] 
- make text file 0=top 1=other [[cli set other label class]] 
- [[cli split train val]] 330 en 58
- zip dataset [[zip command on mac zonder metadata en DS_Store]] en copy naar gdrive 
- model top-bottom trainen 
- cli locaal top-other split [[cli build dataset top]] 

2026-05-11
- successful assembly of the prototype
- model tested in trap: vcra detection is too low

2026-04-14
- ESP32-S3 now has an I2C scan + LED controller mode (protocol still [to be verified])
- [[gv2 firmware I2C]]
- iic now works
...
2026-03-28
- codex [[2026-03-28 overview.md]]
- codex [[2026-03-28 tests.md]]
- allpx 0.302
- 30px 0.34
- 40 px 0.307
- 60px 0.537
