**One-line purpose:** calculation of size of the insects on the pi cam v1.3
**Short summary:** uses to select 30px, 40px and 60px images
**Agent:** calculation from user
**SoT:** yes
